...
public class MyListAdapter extends BaseAdapter /*implements StickyListHeadersAdapter */ {
    ...
    public MyListAdapter(Context context, ArrayList<UserDetails> name) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String tavolaString = Utils.getTavolaStringFullScreen(details.getNationalID(), details.getInc_area(), details.getTavola1(), details.getTavola2());
//        http://www.roundtable.it/uploads/tx_annuario/RTSM%20-%20Logo%20trasparente_02.gif
        holder.addressTv.setText(tavolaString + " - RT" + details.getTavola() + " " + details.getClub_city_name());
